/*
    ...
    Verifier le chemin des librairies (sketchbook arduino
    Reprendre IP ordinateur
    Connecteur les deux ordis au routeur
    Outils : le port, CPU, etc.*/
...
const char * ssid = "Movuino_3020_6CC0C0";               // your network SSID (name of the wifi network)
const char * pass = "z12345678";               // your network password
const char * hostIP = "192.168.0.102";            // IP address of the host computer
const unsigned int port = 7400;                  // port on which data are sent (send OSC message)
const unsigned int localPort = 3011;             // local port to listen for UDP packets (receive OSC message)
