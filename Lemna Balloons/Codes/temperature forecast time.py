...
plt.title("Evolution of the temperature forecast time for an initial nitrates  concentration of")
...
with open('Tableau pré-csv - Concentration en nitrate 1(2).csv', 'rb') as csvfile: #Open the file
    reader = csv.reader(csvfile) #read the file
    reader.next() #switch the first line
    reader.next() #switch the second line
    for row in reader:
...
plt.xlabel("Time")
plt.ylabel("Temperature")
plt.title("Evolution of temperature forecast time for an initial nitrates concentration of")
