#Final concentration of algae in function of the concentration of nitrate
...
plt.title("Final concentration of algae in function of the concentration of nitrate")
plt.show()
